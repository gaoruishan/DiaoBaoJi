...
public class BadgeView extends TextView {
	 ...
	 * 水平边距
	 */
	private int badgeMarginH;// 水平边距
	/**
	 * 垂直边距
	 */
	private int badgeMarginV;// 垂直边距
	/**
	 * 颜色
	 */
	private int badgeColor;// 颜色
	...
	public BadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);// 五个参数
	}
	...
	public BadgeView(Context context, View target) {
		this(context, null, android.R.attr.textViewStyle, target, 0);// 五个参数
	}
	...
	private void init(Context context, View target, int tabIndex) {
		...
		/**
		 * Interpolator()
		 * 被用来修饰动画效果，定义动画的变化率，可以使存在的动画效果accelerated(加速)，decelerated(
		 * 减速),repeated(重复),bounced(弹跳)等。
		 */
