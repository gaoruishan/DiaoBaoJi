...
public class CenterOrderListViewAdapter1 extends AppBaseAdapter<OrderBean> {

	private BitmapUtils bitmapUtils;
	private Date date;

	public CenterOrderListViewAdapter1(List<OrderBean> list, Context context) {
		super(list, context);
	...
	public void setChangeDatas(List<OrderBean> list) {
		this.list = list;
		notifyDataSetChanged();
	}
}
